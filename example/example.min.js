...
},{"d3":4,"d3-tip":3}],2:[function(require,module,exports){
'use strict';
...
(0, _2.default)(_d2.default);

function loadVis(url) {
  _d2.default.select('#graph').html('');
  _d2.default.json(url, function (err, data) {
    if (err) return console.warn(err);
    _d2.default.jsonldVis(data, '#graph', { w: 800, h: 600, maxLabelWidth: 250 });
  });
}

_d2.default.select('#load').on("click", function () {
  loadVis(_d2.default.select('#url').property('value'));
});

loadVis('example.json');

},{"..":1,"d3":4}],3:[function(require,module,exports){
// d3.tip
